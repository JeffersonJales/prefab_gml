...
#macro PREFAB_INSTANCE_AUTO_IMPLEMENTS true					/// Case you're using objects that are NOT a children of the obj_prefab or not used prefab_local_init, its can setup this too you
